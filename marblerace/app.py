...
marble_feature = ["old", "shiny", "bright", "opaque", 
                    "transparent", "swirly", "round", 
                    "big", "small", "fast", "metallic", 
                    "neon", "smooth", "textured", "matte",
                    "dim", "crystal", "dark", "starry",
                    "speckled"]
marble_behavior = ["spinning", "bouncing", "rolling", 
                    "twirling", "flipping", "crashing", 
                    "jumping", "hopping", "cascading", 
                    "accelerating", "ricocheting", "rotating",
                    "traveling", "passing", "cruising"]
...
def background_thread():
    ...
    while count < 11:
        ...
        socketio.emit('my_response',
                      {'data': 'The ' + change_position() + ' car is ' + random.choice(marble_behavior) +" around the "+ marble_picker1 + " car!" , 'count': count},
                      namespace='/test')
